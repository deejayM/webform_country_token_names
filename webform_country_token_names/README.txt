...
What I have is a country code selection in webform .  When outputting this in the Webform Emails the value in  [submission:values:country]  is the country code.  In address field token the notes state\

What I needed to is output the Country name.
